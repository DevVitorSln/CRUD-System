    ...
    public class SegurancaSistema
    {
        ...
        public static SecureString MascararSenha()
        {
            ...
            do
            {
                ...
                else if (KeyInfo.Key == ConsoleKey.Backspace && senha.Length > 0)
                {
                    ...
                    MenuFuncoesUsuario.ImprimirMensagem("\b \b");
                }
            }
        ...
        public static void CarregarConfiguracao()
        {
            try
            {
                ...
                Config = JsonConvert.DeserializeObject<Config>(conteudoArquivo);

                VerificaSalt();

                Console.Clear();
                MenuFuncoesUsuario.ImprimirMensagem("Senha para Criptografar o arquivo: ");
            ...
            catch (JsonException)
            {
                ...
                Console.Clear();
                MenuFuncoesUsuario.ImprimirMensagem("Senha para Descriptografar o arquivo: ");
                ...
                Config = JsonConvert.DeserializeObject<Config>(arquivoString);
        ...
        public static void VerificarAssinatura(Documento documento)
        {
            ...
            if (rsaKey.VerifyData(byteDadoOriginal, byteAssinatura, HashAlgorithmName.SHA256, RSASignaturePadding.Pkcs1))
            {
                MenuFuncoesUsuario.ImprimirMensagem("\nAssinatura válida!");
        ...
        public static void GerarAssinatura(Documento documento, string privateKey, Usuario usuario)
        {
            ...
            string hashAssinatura = Convert.ToBase64String(byteAssinatura);

            if (hashAssinatura == null)
            {
                MenuFuncoesUsuario.ImprimirErro("O documento não foi assinado.");
                MenuFuncoesUsuario.Continuar();
            ...
            {
                BancoSistema.AtualizarDocumento(documento, hashAssinatura, "Assinatura");
                BancoSistema.AtualizarDocumento(documento, StatusDocumento.Assinado, "Status");
                BancoSistema.AtualizarDocumento(documento, usuario.ChavePublica, "ChavePublica");
